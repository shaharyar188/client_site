                ...
                <div className="auto-container">
                    ...
                    <ul className="gallery-carousel owl-carousel owl-theme wow fadeInUp">
                        <li className="gallery-item">
                            ...
                            <Link
                                to="assets/images/new_images/a1.jpg"
                                className="lightbox-image"
                            >
                                <img
                                    src="assets/images/new_images/a1.jpg"
                                    alt=""
                                    style={{ height: 170 }}
                                />
                            </Link>
                        ...
                        <li className="gallery-item">
                            ...
                            <Link
                                to="assets/images/new_images/a5.jpg"
                                className="lightbox-image"
                            >
                                <img
                                    src="assets/images/new_images/a2.jpg"
                                    alt=""
                                    style={{ height: 170 }}
                                />
                            </Link>
                        ...
                        <li className="gallery-item">
                            ...
                            <Link
                                to="assets/images/new_images/a3.jpg"
                                className="lightbox-image"
                            >
                                <img
                                    src="assets/images/new_images/a3.jpg"
                                    alt=""
                                    style={{ height: 170 }}
                                />
                            </Link>
